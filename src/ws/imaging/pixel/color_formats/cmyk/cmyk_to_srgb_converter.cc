#include "ws/imaging/pixel/color_formats/cmyk/cmyk_to_srgb_converter.h"
namespace ws {
namespace imaging {
...
template class CmykToSRgbConverter<uint8_t>;
template class CmykToSRgbConverter<int8_t>;
template class CmykToSRgbConverter<uint16_t>;
